...
class VerificationResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> VerificationResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/prembly-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> VerificationResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/prembly-python#with_streaming_response
        """
